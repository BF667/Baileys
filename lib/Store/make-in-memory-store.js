...
import { KeyedDB } from './keyed-db.js' // <-- Import our custom KeyedDB
...
export const makeInMemoryStore = (config) => {
    ...
    const chats = new KeyedDB(chatKey, c => c.id) // <-- Use our custom KeyedDB
    const messages = {}
    const contacts = {}
    const groupMetadata = {}
    const presences = {}
    ...
    const labelAssociations = new KeyedDB(labelAssociationKey, labelAssociationKey.key) // <-- Use our custom KeyedDB
