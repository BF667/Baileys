...
/**
 * Helper functions to create different types of interactive buttons
 */

/**
 * Create a quick reply button
 * @param {string} id - Button ID for identifying the response
 * @param {string} text - Display text for the button
 * @returns {object} Quick reply button object
 */
function createQuickReplyButton(id, text) {
  return {
    name: 'quick_reply',
    buttonParamsJson: JSON.stringify({
      display_text: text,
 ...
 * @param {string} text - Display text for the button
 * @param {string} phoneNumber - Phone number to call (with country code)
 * @returns {object} Call button object
 */
function createCallButton(text, phoneNumber) {
  return {
    name: 'cta_call',
    buttonParamsJson: JSON.stringify({
      display_text: text,
 ...
 * @param {string} text - Display text for the button
 * @param {string} code - Code or text to copy
 * @returns {object} Copy button object
 */
function createCopyButton(text, code) {
  return {
    name: 'cta_copy',
    buttonParamsJson: JSON.stringify({
      display_text: text,
...
/**
 * Create a send location button
 * @param {string} text - Display text for the button
 * @returns {object} Location button object
 */
function createLocationButton(text) {
  return {
    name: 'send_location',
    buttonParamsJson: JSON.stringify({
      display_text: text
 ...
 * @returns {object} Catalog button object
 */
function createCatalogButton(text, phoneNumber) {
  return {
    name: 'cta_catalog',
    buttonParamsJson: JSON.stringify({
      display_text: text,
...
// Create aliases for renamed exports
const sendButtons = sendInteractiveButtonsBasic;
...
export { 
  ...
  // Export button creation helpers
